...
import com.disarm.surakshit.pdm.Chat.MediaPlayerActivity;
...
public class CustomInfoWindow extends InfoWindow {
    ...
    public void onOpen(Object item) {
        ...
        try {
            ...
            ListAdapter adapter = new CustomAdapter(context,files);
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    if (fileName.contains("jpeg")) {
                        ...
                        folderName = folderName + "SurakshitAudio/"+fileName;
                        Intent ii = new Intent(context, MediaPlayerActivity.class);
                        ii.putExtra("url",folderName);
                        context.startActivity(ii);
                    }
